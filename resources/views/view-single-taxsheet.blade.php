                      ...
                      <div class="table-responsive mt-2 ">
                        <table id="example3" class="table align-middle mb-0 ">
                          ...
                          <tbody>
                            ...
                            $i=1;
                            ?>
                            @foreach ($payslips_data as $payslip_data)
                            <tr>
                              <td>{{$i}}</td>
                              <td>{{$payslip_data->fullName}}</td>
                              <td>{{$payslip_data->locationId}}</td>
                              <td>{{$payslip_data->netPay}}</td>
                              <td>{{$payslip_data->youEpf}}</td>
                              <td>{{$payslip_data->companyEpf}}</td>
                              <td>{{$payslip_data->companyEtf}}</td>
                            </tr>
                            <?php
                            $i++;
                            ?>
