 ...
 <!--start wrapper-->
                      ...
                      <form class="row g-3" action="{{route("new.paySlip")}}" method="GET">
                        ...
                        <div class="col-6">
                            ...
                            <select id="name_of_employee" name="fullName" class="single-select">
                              ...
                              @if ($Single_emp_name==$payslip["fullName"])
                              <option selected value="{{$Single_emp_name}}">{{$Single_emp_name}}</option> 
                              @else
                        ...
                        <div class="col-6">
                          ...
                          <input name="basicSalary" value="{{$payslip["basicSalary"]}}" type="number" id="first_basic_salary"  class="form-control" required>
                        </div>
                        ...
                        <input 
                        @isset($payslip["daysInMonth"])
                            value="{{$payslip["daysInMonth"]}}"
                        @endisset 
                        name="daysInMonth" id="daysInMonth" class="form-control mb-3" type="number" placeholder="" aria-label="default input example" readonly>
                        </div>
                        <div class="col-6 col-lg-4">
                        <label class="form-label">Paid Days</label>
                            <input
                            @isset($payslip["paidDays"])
                            value="{{$payslip["paidDays"]}}"
                        @endisset 
                             name="paidDays" class="form-control mb-3" type="number" placeholder="" aria-label="default input example">
                        </div>
                        <div class="col-6 col-lg-4">
                        <label class="form-label">LOP Days</label>
                            <input 
                            @isset($payslip["LopDays"])
                            value="{{$payslip["LopDays"]}}"
                        @endisset 
                            name="LopDays" class="form-control mb-3" type="number" placeholder="" aria-label="default input example">
                        </div>
                        <div class="col-6 col-lg-4">
                        <label class="form-label">Overtime Days</label>
                            <input
                            @isset($payslip["overTimeDays"])
                            value="{{$payslip["overTimeDays"]}}"
                        @endisset 
                            name="overTimeDays" class="form-control mb-3" type="number" placeholder="" aria-label="default input example">
                        </div>
                        <div class="form-space"></div>
                        <hr>
                        ...
                        <div class="col-lg-12 form-field-main">
                          ...
                          <input
                          @isset($payslip["basicSalary"])
                            value="{{$payslip["basicSalary"]}}"
                        @endisset 
                          id="basicSalary" type="number" class="form-control mb-3 form-field" readonly>
                        </div>
                        <div class="col-lg-12 form-field-main">
                          <label class="form-label-inline" style="padding: 7px 0;">Attendance Allowance</label>
                          <input
                          @isset($payslip["attendanceAllowance"])
                          value="{{$payslip["attendanceAllowance"]}}"
                      @endisset 
                          name="attendanceAllowance" id="attendanceAllowance" value="0" type="number" class="form-control mb-3 form-field">
                        </div>
                        <div class="col-lg-12 form-field-main">
                          <label class="form-label-inline" style="padding: 7px 0;">F&B Allowane</label>
                          <input
                          @isset($payslip["fAndBAllowance"])
                          value="{{$payslip["fAndBAllowance"]}}"
                      @endisset 
                          name="fAndBAllowance" id="fAndBAllowance" value="0" type="number" class="form-control mb-3 form-field">
                        </div>
                        <div class="col-lg-12 form-field-main">
                          <label class="form-label-inline" style="padding: 7px 0;"><b>Gross Salary</b></label>
                          <input
                          @isset($payslip["grossSalary"])
                          value="{{$payslip["grossSalary"]}}"
                      @endisset 
                          name="grossSalary" id="grossSalary"  type="number" class="form-control mb-3 form-field" readonly>
                        </div>
                          <br>
                          ...
                          value="{{$payslip["bonus"]}}"
                      @endisset 
                            name="bonus" id="bonus" value="0" type="number" class="form-control mb-3 form-field">
                          </div>
                          <div class="col-lg-12 form-field-main">
                            <label class="form-label-inline" style="padding: 7px 0;">Over Time Pay</label>
                            <input
                            @isset($payslip["overTimePay"])
                          value="{{$payslip["overTimePay"]}}"
                      @endisset 
                            name="overTimePay" id="overTime" value="0" type="number" class="form-control mb-3 form-field">
                          </div>
                        <!--  <div class="col-lg-12">
                          ...
                          <div class="col-lg-12 form-field-main">
                            ...
                            <input
                            {{-- @isset($payslip["totalEarnings"])
                          value="{{$payslip["totalEarnings"]}}"
                      @endisset  --}}
                            name="totalEarnings" id="totalEarning"  type="number" class="form-control mb-3 form-field" readonly>
                          </div>
                      </div>
                      <!--end earnings-->
                      ...
                      <!--start deductions-->
                        <div class="col-lg-6 px-4">
                          ...
                          <div class="col-lg-12 form-field-main">
                            ...
                            <input
                            @isset($payslip["youEpf"])
                            value="{{$payslip["youEpf"]}}"
                        @endisset 
                            name="youEpf" id="youEpf" type="number" class="form-control mb-3 form-field" readonly>
                          </div>
                          <div class="col-lg-12 form-field-main">
                            <label class="form-label-inline" style="padding: 7px 0;">From Company EPF 12%</label>
                            <input
                            @isset($payslip["companyEpf"])
                            value="{{$payslip["companyEpf"]}}"
                        @endisset 
                            name="companyEpf" id="companyEpf" type="number" class="form-control mb-3 form-field" readonly>
                          </div>
                          <div class="col-lg-12 form-field-main">
                            <label class="form-label-inline" style="padding: 7px 0;">From Company ETF 3%</label>
                            <input
                            @isset($payslip["companyEtf"])
                            value="{{$payslip["companyEtf"]}}"
                        @endisset 
                            name="companyEtf" id="companyEtf" type="number" class="form-control mb-3 form-field" readonly>
                          </div>
                          <div class="col-lg-12 form-field-main">
                            <label class="form-label-inline" style="padding: 7px 0;">Salary Advance</label>
                            <input
                            @isset($payslip["salaryAdvance"])
                            value="{{$payslip["salaryAdvance"]}}"
                        @endisset 
                            name="salaryAdvance" id="salaryAdvance" value="0" type="number" class="form-control mb-3 form-field">
                          </div>
                          <br>
  ...
  var yourEPF= document.getElementById("youEpf").value;
    ...
    if(!salaryAdvance.value){
       ...
       var totalDeductions = document.getElementById("totalDeductions").value=totalTaxCut+parseInt(salaryAdvance.value);
...
var overTime=document.getElementById("overTime");
        ...
        document.getElementById("netPay").value=parseInt(totalEarning)-parseInt(totalDeductions);
  </script>

<script>
  //   $(document).ready(function(){
  //     $("#name_of_employee").click(function(){
