...
<html lang="en" class="light-theme">
 ...
 <!--start wrapper-->
     ...
     <!--end sidebar -->
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                <div class="col-lg-3">
                <a href="{{route("form.employee")}}"><button type="button" class="btn btn-primary btn-lg">Add Employee</button></a>
                </div>
                <br>
                       ...
                       <div class="table-responsive mt-2 ">
                        <table id="example2" class="table align-middle mb-0 ">
                          ...
                          <tr>
                            ...
                            <td>{{$employee->basicSalary}}</div></td>
                            <td>
                              <div class="d-flex align-items-center gap-3 fs-6">
                                <a href="{{route('view.employee',["id" => $employee->id])}}" class="text-primary" aria-label="Views"><ion-icon name="eye-sharp"></ion-icon></a>



                                <a href="{{route('editForm.employee',["id" => $employee->id])}}" class="text-warning" aria-label="Edit"><ion-icon name="pencil-sharp"></ion-icon></a>



                               <form id="delete_form_{{$employee->id}}" method="POST" action="{{route('delete.employee',["id" => $employee->id])}}"  >

                                 @method('Delete')

                                 @csrf
                                
                                 <button style="background: none; border:none;" type="button" onclick="confirmation({{$employee->id}})" class="text-danger" aria-label="Delete">
  ...
  <!--end wrapper-->
    ...
    confirmation=(id)=>{
          if (confirm("Employee will be deleted ! ")) {
