                ...
                <div class="card radius-10" id="payslip">
                    <div class="card-header py-3 invoice-header">
                         <div class="row align-items-center g-3">
                           ...
                           @else
                           <img src="assets/images/dutraservices.png" width="400px;">       
                           @endif
                           </div>
                    ...
                    <div class="card-header py-2">
                        <div class="row text-center pt-2">
                            <p class="fs-5">Payslip For the Period of {{$payslip[0]->startDate}} to {{$payslip[0]->endDate}}</p>
                        </div>
                      </div>
                    <div class="card-header py-2">
                        ...
                        <div class="col">
                         <div class="">
                            <dl class="row">
                                ...
                                <dd class="col-sm-6">{{$employee[0]->id}}</dd>
                        ...
                        <div class="col">
                         <div class="">
                            <dl class="row">
                                ...
                                <dd class="col-sm-6">{{$payslip[0]->paidDays}}</dd>
                                <dt class="col-sm-6">LOP Days</dt>
                                <dd class="col-sm-6">{{$payslip[0]->LopDays}}</dd>
                                <dt class="col-sm-6">Days in Month</dt>
                                <dd class="col-sm-6">{{$payslip[0]->daysInMonth}}</dd>
                                <dt class="col-sm-6">Overtime Days</dt>
                                <dd class="col-sm-6">{{$payslip[0]->overTimeDays}}</dd>
                   ...
                   <div class="card-body">
                       ...
                       <table class="table table-invoice">
                          ...
                          <tbody>
                             <tr>
                                ...
                                <td class="text-center">${{$payslip[0]->basicSalary}}</td>
                             </tr>
                             <tr>
                                <td>
                                   <span class="text-inverse">Attendance Allowance</span><br>
                                   </td>
                                <td class="text-center">${{$payslip[0]->attendanceAllowance}}</td>
                             </tr>
                             <tr>
                                <td>
                                   <span class="text-inverse">F&B Allowance</span><br>
                                   </td>
                                <td class="text-center">${{$payslip[0]->fAndBAllowance}}</td>
                             </tr>
                             <tr>
                                <td>
                                   <span class="text-inverse"><b>Gross Salary</b></span><br>
                                   </td>
                                <td class="text-center">${{$payslip[0]->grossSalary}}</td>
                             </tr>
                          </tbody>
                       </table>
                      </div>
                          ...
                          <table class="table table-invoice">
                             ...
                             <tbody>
                                <tr>
                                   ...
                                   <td class="text-center">${{$payslip[0]->youEpf}}</td>
                                </tr>
                                <tr>
                                    <td>
                                       <span class="text-inverse">From Company EPF 12%</span><br>
                                       </td>
                                    <td class="text-center">${{$payslip[0]->companyEpf}}</td>
                                 </tr>
                                 <tr>
                                    <td>
                                       <span class="text-inverse">From Company ETF 3%</span><br>
                                       </td>
                                    <td class="text-center">${{$payslip[0]->companyEtf}}</td>
                                 </tr>
                                 <tr>
                                    <td>
                                       <span class="text-inverse">Salary Advance</span><br>
                                       </td>
                                    <td class="text-center">${{$payslip[0]->salaryAdvance}}</td>
                                 </tr>
                             </tbody>
                          </table>
                       </div>
                          ...
                          <table class="table table-invoice">
                             ...
                             <tbody>
                                <tr>
                                   ...
                                   <td class="text-center">${{$payslip[0]->overTimePay}}</td>
                                </tr>
                                <tr>
                                    <td>
                                       <span class="text-inverse">Bonus</span><br>
                                       </td>
                                    <td class="text-center">${{$payslip[0]->bonus}}</td>
                                 </tr>
                                 <tr>
                                    <td>
                                       <span class="text-inverse">Other Earning</span><br>
                                       </td>
                                    <td class="text-center">${{$payslip[0]->otherEarnings}}</td>
                                 </tr>
                             </tbody>
                          </table>
                       </div>
                          ...
                          <table class="table table-invoice">
                             ...
                             <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">${{$payslip[0]->otherDeductions}}</td>
                                 </tr>
                             </tbody>
                          </table>
                       </div>
                              ...
                              <table class="table table-invoice">
                                 ...
                                 <tbody>
                                    ...
                                    <h5><span class="text-inverse fs-5">Total Earnings</span><br></h5>
                                       ...
                                       <td class="text-center fs-5"><h5>${{$payslip[0]->totalEarnings}}</h5></td>
                                    </tr>
                                 </tbody>
                              </table>
                           </div>
                              ...
                              <table class="table table-invoice">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td class="text-center fs-5"><h5>${{$payslip[0]->totalDeductions}}</h5></td>
                                    </tr>
                                 </tbody>
                              </table>
                           </div>
                    ...
                    <div class="row  align-items-center m-0">
                      ...
                      <div class="col bg-primary col-auto p-4">
                       ...
                       <h4 class="mb-0 text-white">${{$payslip[0]->netPay}}</h4>
                      </div>
                    </div><!--end row-->
                    ...
                    <div class="card-header py-3">
                         <div class="row align-items-end g-3">
                            ...
                            <div class="col-12 col-lg-12 text-md-end">
                                <a href="javascript:;" value="click" onclick="printDiv()" class="btn btn-secondary me-2"><ion-icon name="print-sharp"></ion-icon>Print</a>
                                <a href="javascript:;" class="btn btn-primary me-2">Send <ion-icon name="send"></ion-icon></a>
                            </div>
